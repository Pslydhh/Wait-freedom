...
public class WaitFreeAtomic3 {
	...
	static {
		try {
			...
			valueObjOffset = UNSAFE.staticFieldOffset(WaitFreeAtomic3.class.getDeclaredField("valueObj"));
			valueBase = UNSAFE.staticFieldBase(WaitFreeAtomic3.class.getDeclaredField("valueObj"));
	...
	static class ThreadObj {
		public ThreadObj(ValueObj valueObj) {
			super();
...
//        inter.incrementAndGet();
        ...
        ThreadObj myselfObj = new ThreadObj(null);
